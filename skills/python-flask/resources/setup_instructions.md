...
Run the `install_python_official.sh` script with the chosen project name, package manager, and application type.

### Command

```bash
bash skills/python-flask/scripts/install_python_official.sh {{projectName}} {{packageManager}} {{type}}
```
...
```bash
bash skills/python-flask/scripts/install_python_official.sh my-flask-app pip web
```
