      ...
      if firebaseTool then
        ...
        in
          \'\'\'
            ...
            # Delete the default page.tsx and replace it with our new content.
            # Using \'EOF\' prevents the shell from trying to expand variables like $ or special characters like [].
