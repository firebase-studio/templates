        ...
        in
          ''
            ...
            if [ -f "$mainPageFile" ]; then
                ...
                # Add the import statement for the Login component with a static path
                sed -i "/'use client';/a import Login from '../../components/login';" "$mainPageFile"
                # Add the Login component before the <main> tag
