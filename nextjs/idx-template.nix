...
let
  loginComponent = pkgs.writeText "login.tsx" \'\'
    \'use client\';
  ...
  pageFile = pkgs.writeText "page.tsx" \'\'
    \'use client\';
    ...
    ${
      if firebaseTool then
        let
          ...
          firebaseTs = pkgs.writeText "firebase.ts" \'\'
        ...
        in
          \'\'
            ...
            cp ${firebaseTs} "$baseDir/lib/firebase.ts"
            cp ${loginComponent} "$baseDir/components/login.tsx"
            
            mainPageFile="$baseDir/app/page.tsx"
            rm -f "$mainPageFile"
            cp ${pageFile} "$mainPageFile"
          \'\'
      else
        ""
    }
